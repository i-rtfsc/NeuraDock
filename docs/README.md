...
### 🚀 入门指南
- [快速入门](./getting_started.md) - 介绍与快速开始
- [安装指南](./installation.md) - 如何安装 NeuraDock
...
- [ADR-004: CQRS 模式](./architecture/adr/004-cqrs-pattern.md) - 命令查询分离
- [ADR-005: WAF 绕过策略](./architecture/adr/005-waf-bypass-strategy.md) - 浏览器自动化

### 📡 API 参考
- [API 参考](./api/api_reference.md) - Tauri IPC 命令和事件
