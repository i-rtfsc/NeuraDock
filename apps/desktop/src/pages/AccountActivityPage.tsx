  ...
  return (
    ...
    >
      ...
      <BentoGrid className="mb-section-gap-sm">
        <Card className="card-vivid group bg-gradient-to-br from-info/10 to-info/5 border-info-border">
        ...
        <Card className="card-vivid group bg-gradient-to-br from-accent-2/10 to-accent-2/5 border-accent-2-border">
          <CardHeader className="pb-2">
        ...
        <Card className="card-vivid group bg-gradient-to-br from-success/10 to-success/5 border-success-border">
          <CardHeader className="pb-2">
        ...
        <Card className="card-vivid group bg-gradient-to-br from-warning/10 to-warning/5 border-warning-border">
          <CardHeader className="pb-2">
