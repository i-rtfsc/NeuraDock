...
export function PageContainer({ children, className, title, actions, headerClassName }: PageContainerProps) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div
        className={cn(
          "flex-1 overflow-auto scrollbar-hide pt-[var(--layout-page-content-padding-top)] px-[var(--layout-page-content-padding)] pb-[var(--layout-page-content-padding)] page-enter",
          className
        )}
      >
        {children}
